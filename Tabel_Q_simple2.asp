...
Server.ScriptTimeout=30
	...
	<!--cmd.CommandText="exec _XMLTabel_simple2 @Query='"+replace(XMLQuery.xml,"'","''")+"'"-->
	cmd.CommandText="exec _XMLTabel_simple2 @Query='"+replace(XMLQuery.xml,"'","''")+"', @forOverwork = 0, @TimeResults = 0"
